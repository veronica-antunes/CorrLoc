...
This code was developed to locate signals using the waveform amplitudes. The code backprojects the envelope of the cross-correlation function between station pairs to give a likeliwood solution. If you use this code please cite as:
